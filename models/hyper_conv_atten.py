...
class HyperAtten(torch.nn.Module):
    ...
    def hyperedge_representation(self, x, hyperedge_index):
        ...
        hyperedge_representations = scatter_add(src=x[hyperedge_index[0]], index=hyperedge_index[1], dim=0,
                                                out=hyperedge_representations)
